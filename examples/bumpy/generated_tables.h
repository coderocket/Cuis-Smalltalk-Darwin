...
if (arg == 1) { return ( ( interval_t ( 8 , 13 ) ) ).at_random(); }
if (arg == 2) { return ( ( interval_t ( 8 , 13 ) ) ).at_random(); }
...
if (arg == 1) { vector<int> v({1 , 2}); return v[rand() % v.size()]; }
if (arg == 2) { vector<int> v({1 , 2}); return v[rand() % v.size()]; }
